...
<div class="template-form-search">
  <div class="container">
    <div class="close template-form-search__close"><img src="/wp-content/themes/and/assets/imgs/the-close.svg" alt="Close"><span>Close</span></div>
        ...
        <?php if($suggestions_option):
          ...
          <div class="suggestions-search">
             ...
             <?php foreach ($suggestions_option as $key => $suggestion) {
                ?><a class="btn-suggestions" href="javascript:;" data-search="<?php echo trim($suggestion); ?>"><?php echo $suggestion; ?></a><?php
                echo (($key+1) < count($suggestions_option)) ? ', ' : '';
             } ?>
          </div>
        <?php endif; ?>
