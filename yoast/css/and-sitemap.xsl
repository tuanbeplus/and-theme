<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:template match="/">
		...
		<body>
		<div id="content">
			<h1>AND XML Sitemap</h1>
			<p class="expl">
				Generated by <a href="https://andorgstg.wpengine.com/" target="_blank" rel="noopener">AND</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
