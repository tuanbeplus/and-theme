...
$sf_user_metadata = pp_saleforce_current_user_metadata($order->get_user_id()); 
        ...
        <table class="pp-table add-attendees-table">
          ...
          <tbody>
            <?php for($i = 0; $i <= ($quantity - 1); $i++) : 
              ...
              $rid_child = isset($slot_item_data['relation_id_child']) ? $slot_item_data['relation_id_child'] : '';
            ...
            <tr class="__slot-item">
              <td class="__slot-number">
                ...
                if(empty($rid)) {
                  ...
                  echo '<a href="#" class="__remove-item" data-rid="'. $rid .'" data-rid-child="'. $rid_child .'" data-order-id="'. $order_id .'">✕ Remove <span class="__std">#'. $i + 1 .'</span></a>'; 
                }
                ?>
              </td>
              <td class="__td-email">
                ...
                <input 
                  type="hidden" 
                  name="relation_id_child[<?php echo $item_key ?>][]" 
                  value="<?php echo $rid_child; ?>">
              </td>
              <td>
                <input 
              ...
              <td>
                <?php $passColor = (!empty($slot_item_data['contact_id']) ? '#8BC34A' : '#9e9e9e'); ?>
                <span class="__status-icon"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M7.25007 2.38782C8.54878 2.0992 10.1243 2 12 2C13.8757 2 15.4512 2.0992 16.7499 2.38782C18.06 2.67897 19.1488 3.176 19.9864 4.01358C20.824 4.85116 21.321 5.94002 21.6122 7.25007C21.9008 8.54878 22 10.1243 22 12C22 13.8757 21.9008 15.4512 21.6122 16.7499C21.321 18.06 20.824 19.1488 19.9864 19.9864C19.1488 20.824 18.06 21.321 16.7499 21.6122C15.4512 21.9008 13.8757 22 12 22C10.1243 22 8.54878 21.9008 7.25007 21.6122C5.94002 21.321 4.85116 20.824 4.01358 19.9864C3.176 19.1488 2.67897 18.06 2.38782 16.7499C2.0992 15.4512 2 13.8757 2 12C2 10.1243 2.0992 8.54878 2.38782 7.25007C2.67897 5.94002 3.176 4.85116 4.01358 4.01358C4.85116 3.176 5.94002 2.67897 7.25007 2.38782ZM15.7071 9.29289C16.0976 9.68342 16.0976 10.3166 15.7071 10.7071L12.0243 14.3899C11.4586 14.9556 10.5414 14.9556 9.97568 14.3899L11 13.3656L9.97568 14.3899L8.29289 12.7071C7.90237 12.3166 7.90237 11.6834 8.29289 11.2929C8.68342 10.9024 9.31658 10.9024 9.70711 11.2929L11 12.5858L14.2929 9.29289C14.6834 8.90237 15.3166 8.90237 15.7071 9.29289Z" fill="<?php echo $passColor; ?>"/> </svg></span>
              </td>
            </tr>
            <?php endfor; ?>
          </tbody>
