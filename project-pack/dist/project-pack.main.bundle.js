...
/***/ "./src/js/background-image-parallax.js":
/*!*********************************************!*\
  !*** ./src/js/background-image-parallax.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PP_BG_Parallax)
/* harmony export */ });
...
var PP_BG_Parallax = /*#__PURE__*/_createClass(function PP_BG_Parallax(elem, options) {
  _classCallCheck(this, PP_BG_Parallax);
  this.elem = elem;
  ...
  this.elem.style.transition = "".concat(this.options.transition);
  this.elem.style.backgroundPosition = "center top";
  this.elem.style.backgroundRepeatY = "repeat";
  var isElemInScreen = function isElemInScreen() {
    var _self$elem$getBoundin = self.elem.getBoundingClientRect(),
      top = _self$elem$getBoundin.top,
      height = _self$elem$getBoundin.height;
    elTop = top;
    elHeight = height;
  ...
  var onScroll = function onScroll(event) {
    ...
    var pos = (elTop - screenHeight) * -1 * self.ratio;
    self.elem.style.backgroundPosition = "center ".concat(pos * -1, "px");
  };
...
(function (w, $) {
  ...
  var removeCartItemFn = function removeCartItemFn() {
    $(document.body).on('pp:wpp_remove_cart_item', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ev, cart_key) {
        var $miniCart, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              $miniCart = $('.pp-minicart');
  ...
  var qttUpdateFn = function qttUpdateFn() {
    $(document.body).on('pp:woo_update_qtt', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ev, cart_key, number) {
        var $miniCart, result;
  ...
  var afterAjaxUpdateCart = function afterAjaxUpdateCart() {
    var __MESS = [{
    ...
    $(document).ajaxComplete(function (event, xhr, settings) {
      var isNoti = __MESS.map(function (item) {
        return item.url;
      }).includes(settings.url);
      if (isNoti) {
        // apply tooltip
        setTimeout(function () {
          // delay append HTMl
          (0,_general__WEBPACK_IMPORTED_MODULE_0__.doTippyGlobal)();
        }, 100);

        // updated cart successfully
        (0,_general__WEBPACK_IMPORTED_MODULE_0__.notificationGlobal)(__MESS.find(function (item) {
          return item.url == settings.url;
        }).message, 3);
      }
    });
  };
  ...
  $(document).ajaxComplete(function (event, xhr, settings) {
    var miniCartBtn_Top = $('a.__mini-cart-button');
    var miniCartBtn_Sidebar = $('.pp-nav__item.__cart a');
    // The AJAX add to cart request has completed
    if (settings.url.indexOf('wc-ajax=add_to_cart') !== -1 || settings.url.indexOf('wc-ajax=remove_from_cart') !== -1 || settings.url.indexOf('wc-ajax=get_refreshed_fragments') !== -1) {
      $.ajax({
        url: wc_add_to_cart_params.ajax_url,
        // WooCommerce's default AJAX URL
        type: 'GET',
        data: {
...
/***/ "./src/js/faq-content-of-table.js":
/*!****************************************!*\
  !*** ./src/js/faq-content-of-table.js ***!
  \****************************************/
/***/ (() => {
...
(function (w, $) {
  ...
  var FAQsContentOfTableFn = /*#__PURE__*/function () {
    function FAQsContentOfTableFn($wrapper) {
      _classCallCheck(this, FAQsContentOfTableFn);
      this.$wrapper = $wrapper;
      this.navList = [];
      this.buildNavigation();

      // console.log(this.navList);
      var content = this.buildNavigationHTML();
      this.$wrapper.parent().find('.faqs-nav').append(content);
    }
    _createClass(FAQsContentOfTableFn, [{
      key: "randID",
      ...
      key: "buildNavigationHTML",
      value: function buildNavigationHTML() {
        var self = this;
        var $_HTML = $('<ul>');
        self.navList.map(function (item) {
          $_HTML.append("<li>\n          <a href=\"".concat(item.selector, "\">").concat(item.heading, "</a>\n          ").concat(function (item) {
            if (!item.child) return '';
            var _child = item.child;
            return "<ul>\n              ".concat(_child.map(function (_item) {
              return "<li><a href=\"".concat(_item.selector, "\">").concat(_item.heading, "</a></li>");
            }).join(''), "\n            </ul>");
          }(item), "\n        </li>"));
        }).join('');
        return $_HTML;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   doTippyGlobal: () => (/* binding */ doTippyGlobal),
/* harmony export */   notificationGlobal: () => (/* binding */ notificationGlobal)
/* harmony export */ });
...
var doTippyGlobal = function doTippyGlobal() {
  var Elems = document.querySelectorAll('*[title]:not(.tippy-added)');
  _toConsumableArray(Elems).forEach(function (e) {
    (0,tippy_js__WEBPACK_IMPORTED_MODULE_1__["default"])(e, {
      content: e.title,
      zIndex: 999999
    });
 ...
 * @return void
 */
var notificationGlobal = function notificationGlobal(text) {
  var timelive = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  jQuery('.pp-notification-global').remove();
  var $_temp = jQuery("<div class=\"pp-notification-global\">\n    <div class=\"__inner\">".concat(text, "</div>\n  </div>"));
...
(function (w, $) {
  ...
  var LandingProductV2 = /*#__PURE__*/function () {
    function LandingProductV2($element) {
      _classCallCheck(this, LandingProductV2);
    ...
    _createClass(LandingProductV2, [{
      key: "__request",
      value: function () {
        var _request = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(action, data) {
          var _n, result;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _n = (0,_general__WEBPACK_IMPORTED_MODULE_0__.notificationGlobal)('Loading...', false);
                _context.next = 3;
                return $.ajax({
                  type: 'POST',
                  url: PP_DATA.ajax_url,
      ...
      value: function triggerActions() {
        ...
        $(document.body).on('LandingProductV2:loadmore', /*#__PURE__*/function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e, params, callback) {
            var result;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return self.__request('pp_ajax_product_loadmore', params);
                case 2:
                  result = _context2.sent;
        ...
        // Filter & search 
        $(document.body).on('LandingProductV2:filter', /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e, params, callback) {
            var result;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return self.__request('pp_ajax_product_filter_v2', params);
                case 2:
      ...
      key: "getMetaPaged",
      value: function getMetaPaged($termContainer) {
        return $termContainer.data();
      }
    }, {
      key: "setMetaPaged",
      value: function setMetaPaged($termContainer, name, value) {
      ...
      value: function loadMore() {
        ...
        this.$container.on('click', '.product-landing-v2-no-term .btn-loadmore', function (e) {
          e.preventDefault();
          var $btn = $(this);
          var $wrapElem = $btn.parents('.product-landing-v2-no-term');
          var $productContainer = $wrapElem.find('.product-card-style');
          var metaPaged = self.getMetaPaged($wrapElem);
          var nextPaged = metaPaged.currentPage + 1;
        ...
        this.$container.on('click', '.product-by-group-term .btn-loadmore', function (e) {
          e.preventDefault();
          var $btn = $(this);
          var $productContainer = $btn.closest('.product-by-group-term').find('.product-card-style');
          var $wrapElem = $btn.parents('.product-by-group-term');
          var metaPaged = self.getMetaPaged($wrapElem);
          var nextPaged = metaPaged.currentPage + 1;
      ...
      value: function filterForm() {
        ...
        self.$container.on('submit', 'form.product-card-filter-form', function (e) {
          ...
          var postPerPage = self.$container.data('post-per-page-for-search');
          var loadmore = self.$container.data('loadmore');
...
(function (w, $) {
  ...
  var landingProduct = /*#__PURE__*/function () {
    function landingProduct($element) {
      _classCallCheck(this, landingProduct);
    ...
    _createClass(landingProduct, [{
      key: "defineElem",
      value: function defineElem() {
      ...
      key: "get_products",
      value: function () {
        var _get_products = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          var append,
            self,
            result,
            _args2 = arguments;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                append = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : true;
                self = this;
                _context2.next = 4;
                return self.__request('pp_get_product_card_style', {
                  s: self.s,
                  cat: self.cat,
      ...
      value: function loadMore() {
        var self = this;
        self.$btnLoadmore.on('click', /*#__PURE__*/function () {
      ...
      key: "submitFormFilter",
      value: function submitFormFilter() {
        var self = this;
        self.$formFilter.on('submit', /*#__PURE__*/function () {
...
(function (w, $) {
  ...
  var offCanvasFn = function offCanvasFn() {
    $(document.body).on('pp:offcanvas_open', function () {
      $(document.body).addClass('__pp-offcanvas-active');
      var focusInterval = setInterval(function () {
        var $closeBtn = document.querySelector('.pp-offcanvas .pp-btn__close');
        $closeBtn.focus();
        setTimeout(function () {
  ...
  $(function () {
    ...
    $(document.body).on('pp:added_to_cart', function () {
      $(document.body).trigger('pp:offcanvas_open');
    });
  });
})(window, jQuery);
...
(function (w, $) {
  ...
  var _PP_DATA = PP_DATA,
    ajax_url = _PP_DATA.ajax_url,
    __ms_graph_token = _PP_DATA.__ms_graph_token,
    __ms_graph_refresh_token = _PP_DATA.__ms_graph_refresh_token,
    ms_client_id = _PP_DATA.ms_client_id,
    ms_scope = _PP_DATA.ms_scope,
    ms_client_secret = _PP_DATA.ms_client_secret,
    ms_return_url = _PP_DATA.ms_return_url;
  var MS_ENDPOINT = 'https://login.microsoftonline.com/consumers/oauth2/v2.0';
  var AUTH_ENDPOINT = "".concat(MS_ENDPOINT, "/authorize");
  var TOKEN_ENDPOINT = "".concat(MS_ENDPOINT, "/token");
  var _Auth = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(callback) {
      var params, authUrl, authBrowser, authBrowserInterval;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            params = {
            ...
            authUrl = "".concat(AUTH_ENDPOINT, "?").concat(qs__WEBPACK_IMPORTED_MODULE_0___default().stringify(params, {
              encode: false
            }));
            authBrowser = w.open(authUrl, '_blank', 'left=100,top=100,width=420,height=500');
            authBrowserInterval = setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var hrefReturn, _hrefReturn$split, _hrefReturn$split2, siteUrl, queryString, _qs$parse, code, __result, _JSON$parse, access_token, refresh_token;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    hrefReturn = authBrowser.location.href;
                    if (!('about:blank' == hrefReturn)) {
                      _context.next = 4;
                      break;
                    }
                  ...
                  case 4:
                    ...
                    _hrefReturn$split = hrefReturn.split('?'), _hrefReturn$split2 = _slicedToArray(_hrefReturn$split, 2), siteUrl = _hrefReturn$split2[0], queryString = _hrefReturn$split2[1];
                    _qs$parse = qs__WEBPACK_IMPORTED_MODULE_0___default().parse(queryString), code = _qs$parse.code;
                    _context.next = 9;
                    return $.get("".concat(ms_return_url, "?code=").concat(code, "&__action=getmstoken"));
                  case 9:
                    __result = _context.sent;
                    _JSON$parse = JSON.parse(__result), access_token = _JSON$parse.access_token, refresh_token = _JSON$parse.refresh_token;
                    authBrowser.close();
    ...
    return function _Auth(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  var addCheduleOutlookCalendar = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(orderID, access_token) {
      var res, result;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
    ...
    return function addCheduleOutlookCalendar(_x2, _x3) {
      return _ref3.apply(this, arguments);
    };
  }();
  var init = function init() {
    $('body').on('click', '.woocommerce-orders-table.woocommerce-MyAccount-orders .button.outlook', /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
        var $btn, _this$href$split, _this$href$split2, link, orderID, result;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              $btn = $(this);
              _this$href$split = this.href.split('#'), _this$href$split2 = _slicedToArray(_this$href$split, 2), link = _this$href$split2[0], orderID = _this$href$split2[1];
              ...
              _context5.next = 8;
              return _Auth( /*#__PURE__*/function () {
                var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref5) {
                  var access_token, refresh_token, result;
                  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                    while (1) switch (_context4.prev = _context4.next) {
                      case 0:
                        access_token = _ref5.access_token, refresh_token = _ref5.refresh_token;
                        $btn.text('Adding chedule...');
                        _context4.next = 4;
                        return addCheduleOutlookCalendar(orderID, access_token);
                      case 4:
            ...
            case 10:
              $btn.text('Adding chedule...');
              _context5.next = 13;
              return addCheduleOutlookCalendar(orderID, __ms_graph_token);
            case 13:
...
(function (w, $) {
  ...
  var addProductToCart = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(product_id, extra_data) {
      var responsive;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
          ...
          case 2:
            ...
            return _context.abrupt("return", responsive);
          case 4:
          case "end":
            return _context.stop();
        }
  ...
  var calendlyEvents = {
    'calendly.event_type_viewed': function calendlyEvent_type_viewed(payload, currentPID) {// init
    },
    'calendly.event_scheduled': function () {
      var _calendlyEvent_scheduled = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(payload, currentPID) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              // Booking completed
              ...
              _context2.next = 3;
              return addProductToCart(currentPID, payload);
            case 3:
      ...
      function calendlyEvent_scheduled(_x3, _x4) {
        return _calendlyEvent_scheduled.apply(this, arguments);
      }
      return calendlyEvent_scheduled;
    }()
  };
...
(function (w, $) {
  ...
  var ProductVariationsForm = /*#__PURE__*/function () {
    function ProductVariationsForm($form) {
      _classCallCheck(this, ProductVariationsForm);
      this.$form = $form;
    ...
    _createClass(ProductVariationsForm, [{
      key: "onKeypressControl",
      value: function onKeypressControl() {
      ...
      key: "onUpdateForm",
      value: function onUpdateForm() {
        var self = this;
        self.$form.on('change', function (e) {
          var $_form = $(this);
          $_form.trigger('pp:product_variant_update_form', [self.getDataForm(), self.variations, self.productParentID]);
        });
      }
    }, {
      key: "onSubmitForm",
      value: function onSubmitForm() {
        ...
        self.$form.on('submit', function (e) {
          e.preventDefault();
          var $_form = $(this);
          $_form.trigger('pp:product_variant_submit_form', [self.getDataForm(), self.variations, self.productParentID]);
        });
      }
    }, {
      key: "_makeData",
      value: function _makeData(data) {
        return _toConsumableArray(data).reduce(function (accumulator, currentValue) {
          if (currentValue.name.indexOf('[]') === -1) {
            accumulator[currentValue.name] = currentValue.value;
          } else {
            var _name = currentValue.name.replace('[]', '');
  ...
  $(function () {
    ...
    $('form.pp-form-product-variations').each(function () {
      ...
      var $btnWidgetBuy = $('.pp-button-choose-slots');
      // const btnWidgetBuy_initText = $btnWidgetBuy.text();

      new ProductVariationsForm($form);
      var updateFormUI = function updateFormUI(_, formData, variations, productParentID) {
        ...
        var variationsSelected = variations.reduce(function (accumulator, currentValue) {
      ...
      var submitFormUI = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_, formData, variations, productParentID) {
          var $btnWidgetBuy, result;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                if (formData.product_variation) {
                ...
                return _context.abrupt("return");
              case 3:
                $btnWidgetBuy = $('.pp-widget__buy .pp-button-choose-slots');
                $form.addClass('pp__loading');
                $btnWidgetBuy.css({
                  opacity: .7,
                  pointerEvents: 'none'
                });
                (0,_general__WEBPACK_IMPORTED_MODULE_0__.notificationGlobal)('Loading...', 5);
                _context.next = 9;
                return $.ajax({
                  type: 'POST',
                  url: PP_DATA.ajax_url,
        ...
        return function submitFormUI(_x, _x2, _x3, _x4) {
          return _ref.apply(this, arguments);
        };
      }();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _background_image_parallax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./background-image-parallax */ "./src/js/background-image-parallax.js");
/**
 * Product 
 * 
 * @version 1.0.0
...
(function (w, $) {
  ...
  var featureImageParallaxFn = function featureImageParallaxFn() {
    var $layers = $('.background-parallax-layer');
    $layers.each(function () {
      new _background_image_parallax__WEBPACK_IMPORTED_MODULE_0__["default"](this);
    });
  };
  var buttonVariationAddToCartFn = function buttonVariationAddToCartFn() {
    var $btn = $('.pp-button-variation-add-to-cart');
    var $form = $('form.pp-form-product-variations');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_general__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/general */ "./src/js/general.js");
/* harmony import */ var _js_landing_products__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/landing-products */ "./src/js/landing-products.js");
/* harmony import */ var _js_landing_products__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_js_landing_products__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _js_landing_products_v2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/landing-products-v2 */ "./src/js/landing-products-v2.js");
/* harmony import */ var _js_faq_content_of_table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/faq-content-of-table */ "./src/js/faq-content-of-table.js");
/* harmony import */ var _js_faq_content_of_table__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_js_faq_content_of_table__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _js_offcanvas__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/offcanvas */ "./src/js/offcanvas.js");
/* harmony import */ var _js_offcanvas__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_js_offcanvas__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _js_checkout_add_attendees_form__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/checkout-add-attendees-form */ "./src/js/checkout-add-attendees-form.js");
/* harmony import */ var _js_checkout_add_attendees_form__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_js_checkout_add_attendees_form__WEBPACK_IMPORTED_MODULE_10__);
/**
 * Project pack
 */
...
/******/ 		var installedChunks = {
/******/ 			"/project-pack.main.bundle": 0,
/******/ 			"css/project-pack.admin.bundle": 0,
/******/ 			"css/project-pack.main.bundle": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkproject_pack"] = self["webpackChunkproject_pack"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/project-pack.admin.bundle","css/project-pack.main.bundle"], () => (__webpack_require__("./src/main.js")))
/******/ 	__webpack_require__.O(undefined, ["css/project-pack.admin.bundle","css/project-pack.main.bundle"], () => (__webpack_require__("./src/scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/project-pack.admin.bundle","css/project-pack.main.bundle"], () => (__webpack_require__("./src/scss/admin.scss")))
